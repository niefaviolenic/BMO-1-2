...
const envSchema = z
  .object({
    ...
    DEVICE_ACTIVE_TIMEOUT_SECONDS: positiveInt(20),
    ...
    HERMES_CONVERSATION: z.string().min(1).default("joy-001"),
    HERMES_SOFT_TIMEOUT_MS: positiveInt(30_000),
    HERMES_HARD_TIMEOUT_MS: positiveInt(180_000),
    VOICE_LLM_PROVIDER: z.enum(["groq", "openai", "hermes", "auto"]).default("auto"),
    GROQ_API_KEY: z.string().optional(),
    OPENAI_API_KEY: z.string().optional(),
    VOICE_LLM_API_KEY: z.string().optional(),
    VOICE_LLM_MODEL: z.string().default("openai/gpt-oss-120b"),
    VOICE_LLM_BASE_URL: z.string().url().default("https://api.groq.com/openai/v1"),
    VOICE_LLM_REASONING_EFFORT: z.enum(["low", "medium", "high", "none"]).default("low"),
    VOICE_LLM_MAX_TOKENS: positiveInt(150),
