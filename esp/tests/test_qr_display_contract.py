...
class QrDisplayContractTest(unittest.TestCase):
    ...
    def test_display_cpp_implements_qr_functions_and_renderer(self) -> None:
        ...
        self.assertIn("qrcodegen_getSize", source)
        self.assertIn("qrcodegen_getModule", source)
        self.assertIn("pairing_fill_x_mirrored_rect", source)
        self.assertIn("QR_MAX_VERSION = 15", source)
        self.assertIn("QR_BAR_Y = 214", source)
        self.assertIn("QR_BAR_HEIGHT = 6", source)
