...
- `RECORD_SILENCE_DURATION_MS = 450 ms` (Jeda hening untuk mengakhiri rekaman);
...
Implementer memverifikasi byte header dan ukuran aktual sebelum upload melalui fungsi `validate_canonical_wav()`.
## Perubahan minimum
